...
const sql =
	'SELECT b.*,r.rating,r.votes,e.parentID,e.season,e.episode FROM basic b JOIN episode e ON b.ID = e.ID LEFT JOIN rating r ON b.ID = r.ID WHERE e.parentID = ? AND e.ID NOT IN (?) ORDER BY e.episode ASC';
